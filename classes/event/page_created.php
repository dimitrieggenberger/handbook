...
/**
 * Event: a handbook page was created.
 *
...
class page_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('newpage', 'local_handbook');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created the handbook page with id '{$this->objectid}'.";
    }
