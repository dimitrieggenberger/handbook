...
$string['audiencesfootnote'] = 'Access is LIVE: any Moodle user whose profile matches an audience value can enter the handbook and sees exactly that audience\'s articles (plus any other audience they also match) — home, categories, search, links and printing are all filtered. An EMPTY value keeps that audience closed. Staff always see everything; the audience selector on the home page previews each portal.';
$string['portalempty'] = 'Your portal has no published articles yet. Check back soon.';
...
$string['qimporteddraft'] = '{$a->count} questions imported into draft v{$a->version}. They take effect when the revision is published.';
$string['qdraftlocked'] = 'The working draft (v{$a->version}) is {$a->status}: questions cannot be edited until it returns to draft or is published.';
$string['qpublishedheading'] = 'Published questions (v{$a}) — what readers answer today';
$string['qnonepublished'] = 'The published revision has no questions: readers see the classic confirm-reading button.';
$string['qdraftheading'] = 'Working draft (v{$a->version} · {$a->status})';
$string['qnonedraft'] = 'The working draft has no questions.';
$string['qnodraftheading'] = 'Working draft';
$string['qnodraftnotice'] = 'No working draft exists. Importing questions will create one from the published revision (content and questions copied), exactly like editing the article does.';
$string['qchangedbadge'] = 'Questions changed';
$string['qunchangedbadge'] = 'unchanged';
$string['qeffectonpublish'] = 'Imported questions land on the working draft and take effect when the revision is published.';
$string['qdeleteall'] = 'Delete all questions';
$string['qdeleted'] = 'Draft questions deleted. If published without questions, the article returns to the classic confirm-reading button.';
$string['confirmdeletequestions'] = 'Delete all comprehension questions from the working draft of "{$a}"? The published questions stay live until this draft is published. Recorded receipts and attempts are kept.';
...
$string['dashtilenever'] = 'with no activity at all';
$string['dashviewed'] = 'Opened without confirming';
$string['dashopens'] = 'Opens';
$string['dashviewedchip'] = '{$a} opened';
$string['dashtileviewed'] = 'pages opened without confirming';
$string['dashdetail'] = 'Reading detail';
$string['dashdetailback'] = 'Back to the dashboard';
$string['dashstateconfirmed'] = 'Confirmed';
$string['dashstatestale'] = 'Re-confirm';
$string['dashstateviewed'] = 'Opened without confirming';
$string['dashstatenone'] = 'Not opened';
$string['dashconfirmedmeta'] = 'confirmed {$a}';
$string['dashstalemeta'] = 'confirmed an earlier version · {$a}';
$string['dashvisitsmeta'] = '{$a->count} visit(s) · last {$a->date}';
$string['dashdetailfootnote'] = 'Opened means the person loaded the article — it does not measure scroll or reading time, and it never counts toward the confirmed percentage. Openings are recorded from the version that introduced this signal onward; earlier visits were never logged.';
...
$string['dashfootnote'] = 'Green = confirmed on the current published version; amber = confirmed an earlier version of a page that changed since; striped gray = opened but never confirmed (the gray zone — recorded activity without commitment); plain background = never opened. Opening never counts toward the percentage: it is context for a conversation, not reading credit. Hidden colleagues are excluded from the list and the aggregates, but their reading records are untouched and they can be restored at any time. This dashboard measures confirmations, not attention.';
...
$string['sgtitle_vs'] = 'Side-by-side comparison (así no / así sí)';
$string['sguse_vs'] = 'Two complete simulations compared next to each other — columns on wide screens, stacked automatically on narrow ones. Each vs-item takes is-bad or is-good, a vs-tag verdict chip ("Así no" / "Así sí") and an optional vs-note explaining why; the markup order is the display order (bad-first or good-first both work). Put a full hb-chat, hb-email or hb-dialogue inside each pane. With the verdict on the pane, per-bubble is-good/is-bad marks are unnecessary.';
...
$string['privacy:pageviewspath'] = 'Article views';
$string['privacy:metadata:local_handbook_pageview'] = 'Article opens: which user opened which handbook page, how many times, first and last.';
$string['privacy:metadata:local_handbook_pageview:userid'] = 'The user who opened the page.';
$string['privacy:metadata:local_handbook_pageview:viewcount'] = 'How many times the page was opened.';
$string['privacy:metadata:local_handbook_pageview:firstviewed'] = 'When the page was first opened.';
$string['privacy:metadata:local_handbook_pageview:lastviewed'] = 'When the page was last opened.';
