...
$string['audiencesfootnote'] = 'El acceso está ACTIVO: cualquier usuario de Moodle cuyo perfil coincida con el valor de una audiencia puede entrar al manual y ve exactamente los artículos de esa audiencia (más los de cualquier otra audiencia con la que también coincida) — portada, categorías, búsqueda, enlaces e impresión quedan filtrados. Un valor VACÍO mantiene esa audiencia cerrada. El personal siempre lo ve todo; el selector de audiencia en la portada previsualiza cada portal.';
$string['portalempty'] = 'Tu portal aún no tiene artículos publicados. Vuelve pronto.';
...
$string['quiztitle'] = 'Comprensión de lectura';
$string['quizsubtitle'] = 'Acierta todas las preguntas para acreditar la lectura de este artículo.';
$string['quizcount'] = '{$a} preguntas';
$string['quizsubmit'] = 'Enviar respuestas';
$string['quizhint'] = 'Responde las {$a} preguntas · intentos ilimitados · las opciones se barajan en cada intento.';
$string['quizretry'] = 'Volver a intentar';
$string['quizretryhint'] = 'Todo se pregunta de nuevo con opciones barajadas; solo un intento con el 100 % acredita la lectura.';
$string['quizfailed'] = '{$a->correct} de {$a->total} correctas. Aún no se acredita la lectura — revisa la retroalimentación y vuelve a intentarlo.';
$string['quizpassed'] = 'Lectura acreditada: {$a->correct} de {$a->total} correctas.';
$string['quizcorrect'] = 'Correcta';
$string['quizincorrect'] = 'Incorrecta';
$string['quizorderwrong'] = 'Orden incorrecto';
$string['quizincomplete'] = 'Responde todas las preguntas antes de enviar.';
$string['quiznoanswer'] = 'No se registró respuesta para esta pregunta.';
...
$string['qimportbtn'] = 'Importar (reemplaza las preguntas actuales)';
$string['qimported'] = '{$a} preguntas importadas.';
$string['qimporteddraft'] = '{$a->count} preguntas importadas al borrador v{$a->version}. Entran en vigor al publicar la revisión.';
$string['qdraftlocked'] = 'El borrador de trabajo (v{$a->version}) está {$a->status}: las preguntas no pueden editarse hasta que vuelva a borrador o se publique.';
$string['qpublishedheading'] = 'Preguntas publicadas (v{$a}) — lo que los lectores responden hoy';
$string['qnonepublished'] = 'La revisión publicada no tiene preguntas: los lectores ven el botón clásico de confirmación de lectura.';
$string['qdraftheading'] = 'Borrador de trabajo (v{$a->version} · {$a->status})';
$string['qnonedraft'] = 'El borrador de trabajo no tiene preguntas.';
$string['qnodraftheading'] = 'Borrador de trabajo';
$string['qnodraftnotice'] = 'No existe un borrador de trabajo. Al importar preguntas se creará uno a partir de la revisión publicada (contenido y preguntas copiados), igual que al editar el artículo.';
$string['qchangedbadge'] = 'Preguntas modificadas';
$string['qunchangedbadge'] = 'sin cambios';
$string['qeffectonpublish'] = 'Las preguntas importadas quedan en el borrador de trabajo y entran en vigor al publicar la revisión.';
$string['qdeleteall'] = 'Eliminar todas las preguntas';
$string['qdeleted'] = 'Preguntas del borrador eliminadas. Si se publica sin preguntas, el artículo vuelve al botón clásico de confirmación.';
$string['confirmdeletequestions'] = '¿Eliminar todas las preguntas de comprensión del borrador de trabajo de «{$a}»? Las preguntas publicadas siguen vigentes hasta que se publique este borrador. Los registros de lectura e intentos se conservan.';
$string['qnoneyet'] = 'Este artículo aún no tiene preguntas de comprensión: los lectores ven el botón clásico de confirmación de lectura.';
$string['qtypemultichoice'] = 'Opción múltiple';
$string['qtypeordering'] = 'Ordenar';
$string['qoptioncount'] = '{$a} opciones';
$string['backtopage'] = 'Volver al artículo';
$string['qimporterrorxml'] = 'No se pudo interpretar el XML. Verifique que esté bien formado (la pauta recomienda validarlo antes de importar).';
$string['qimportskippedtype'] = 'Se omitió una pregunta de tipo no compatible «{$a}» (solo opción múltiple y ordenar aplican a la acreditación de lectura).';
$string['qimportnotitle'] = 'Una pregunta no tiene q-title (ni name); la pauta exige un título natural.';
$string['qimportbadmc'] = 'Pregunta «{$a}» rechazada: opción múltiple requiere al menos 2 opciones y exactamente una con fraction 100.';
$string['qimportbadordering'] = 'Pregunta «{$a}» rechazada: ordenar requiere al menos 2 pasos.';
$string['qimportnofeedback'] = 'Pregunta «{$a}»: algunas opciones no tienen retroalimentación — la pauta la exige.';
$string['qimportcountwarning'] = 'Se importaron {$a} preguntas; la pauta recomienda entre 2 y 6 por artículo.';
$string['qimportempty'] = 'No se encontraron preguntas importables en el XML.';
$string['privacy:attemptspath'] = 'Intentos de pruebas de comprensión';
$string['privacy:metadata:local_handbook_qattempt'] = 'Los intentos de pruebas de comprensión registran quién intentó qué artículo, el puntaje y si aprobó.';
$string['privacy:metadata:local_handbook_qattempt:userid'] = 'El usuario que realizó el intento.';
$string['privacy:metadata:local_handbook_qattempt:timecreated'] = 'Cuándo se realizó el intento.';
...
$string['dashtilenever'] = 'sin ninguna actividad';
$string['dashviewed'] = 'Abiertos sin confirmar';
$string['dashopens'] = 'Aperturas';
$string['dashviewedchip'] = '{$a} hojeados';
$string['dashtileviewed'] = 'páginas abiertas sin confirmar';
$string['dashdetail'] = 'Detalle de lectura';
$string['dashdetailback'] = 'Volver al panel';
$string['dashstateconfirmed'] = 'Confirmado';
$string['dashstatestale'] = 'Reconfirmar';
$string['dashstateviewed'] = 'Abierto sin confirmar';
$string['dashstatenone'] = 'Sin abrir';
$string['dashconfirmedmeta'] = 'confirmado el {$a}';
$string['dashstalemeta'] = 'confirmó una versión anterior · {$a}';
$string['dashvisitsmeta'] = '{$a->count} visita(s) · última {$a->date}';
$string['dashdetailfootnote'] = '«Abierto» significa que la persona cargó el artículo — no mide scroll ni tiempo de lectura, y nunca suma al porcentaje confirmado. Las aperturas se registran desde la versión que introdujo esta señal; las visitas anteriores no quedaron registradas.';
...
$string['dashfootnote'] = 'Verde = confirmado en la versión publicada vigente; ámbar = confirmó una versión anterior de una página que cambió después; gris rayado = abierto pero nunca confirmado (la zona gris: actividad registrada sin compromiso); fondo liso = nunca abierto. Abrir nunca suma al porcentaje: es contexto para conversar, no crédito de lectura. Las personas ocultas quedan fuera de la lista y de los promedios, pero sus registros de lectura no se tocan y pueden restaurarse en cualquier momento. Este tablero mide confirmaciones, no atención.';
...
$string['sgtitle_vs'] = 'Comparación lado a lado (así no / así sí)';
$string['sguse_vs'] = 'Dos simulaciones completas comparadas una junto a la otra: columnas en pantalla ancha, apiladas automáticamente en pantalla estrecha. Cada vs-item lleva is-bad o is-good, una etiqueta de veredicto vs-tag («Así no» / «Así sí») y una vs-note opcional que explica el porqué; el orden del marcado es el orden en pantalla (primero el malo o primero el bueno, ambos valen). Dentro de cada panel va un hb-chat, hb-email o hb-dialogue completo. Con el veredicto en el panel, las marcas is-good/is-bad por globo son innecesarias.';
...
$string['readingtimetotal'] = '≈ {$a} min de lectura';
$string['readingtimeleft'] = 'quedan ≈ {$a} min';
$string['estimatedminutes'] = 'Minutos estimados de lectura';
$string['estimatedminutes_help'] = 'Deje 0 para la estimación automática: el conteo de palabras de los artículos publicados a ~200 palabras por minuto (las imágenes suman unos segundos cada una). Escriba un valor para sobrescribirla — útil cuando la ruta incluye videos, formularios o actividades que el conteo de palabras no puede ver.';
...
$string['privacy:pageviewspath'] = 'Aperturas de artículos';
$string['privacy:metadata:local_handbook_pageview'] = 'Aperturas de artículos: qué persona abrió qué página del manual, cuántas veces, primera y última.';
$string['privacy:metadata:local_handbook_pageview:userid'] = 'La persona que abrió la página.';
$string['privacy:metadata:local_handbook_pageview:viewcount'] = 'Cuántas veces se abrió la página.';
$string['privacy:metadata:local_handbook_pageview:firstviewed'] = 'Cuándo se abrió la página por primera vez.';
$string['privacy:metadata:local_handbook_pageview:lastviewed'] = 'Cuándo se abrió la página por última vez.';
