...
$string['audiencesfootnote'] = 'Der Zugang ist AKTIV: jeder Moodle-Nutzer, dessen Profil dem Wert einer Zielgruppe entspricht, kann das Handbuch betreten und sieht genau die Artikel dieser Zielgruppe (plus jeder weiteren passenden Zielgruppe) — Startseite, Kategorien, Suche, Links und Druck sind gefiltert. Ein LEERER Wert hält die Zielgruppe geschlossen. Das Personal sieht immer alles; die Zielgruppenauswahl auf der Startseite zeigt jedes Portal in der Vorschau.';
$string['portalempty'] = 'Dein Portal hat noch keine veröffentlichten Artikel. Schau bald wieder vorbei.';
...
$string['qimporteddraft'] = '{$a->count} Fragen in Entwurf v{$a->version} importiert. Sie treten mit der Veröffentlichung der Revision in Kraft.';
$string['qdraftlocked'] = 'Der Arbeitsentwurf (v{$a->version}) ist {$a->status}: Fragen können nicht bearbeitet werden, bis er zum Entwurf zurückkehrt oder veröffentlicht wird.';
$string['qpublishedheading'] = 'Veröffentlichte Fragen (v{$a}) — was Lesende heute beantworten';
$string['qnonepublished'] = 'Die veröffentlichte Revision hat keine Fragen: Lesende sehen den klassischen Bestätigungs-Button.';
$string['qdraftheading'] = 'Arbeitsentwurf (v{$a->version} · {$a->status})';
$string['qnonedraft'] = 'Der Arbeitsentwurf hat keine Fragen.';
$string['qnodraftheading'] = 'Arbeitsentwurf';
$string['qnodraftnotice'] = 'Es existiert kein Arbeitsentwurf. Beim Importieren von Fragen wird einer aus der veröffentlichten Revision erstellt (Inhalt und Fragen kopiert), genau wie beim Bearbeiten des Artikels.';
$string['qchangedbadge'] = 'Fragen geändert';
$string['qunchangedbadge'] = 'unverändert';
$string['qeffectonpublish'] = 'Importierte Fragen landen im Arbeitsentwurf und treten mit der Veröffentlichung der Revision in Kraft.';
$string['qdeleteall'] = 'Alle Fragen löschen';
$string['qdeleted'] = 'Entwurfsfragen gelöscht. Wird ohne Fragen veröffentlicht, kehrt der Artikel zum klassischen Bestätigungs-Button zurück.';
$string['confirmdeletequestions'] = 'Alle Verständnisfragen aus dem Arbeitsentwurf von „{$a}" löschen? Die veröffentlichten Fragen bleiben in Kraft, bis dieser Entwurf veröffentlicht wird. Erfasste Lektüren und Versuche bleiben erhalten.';
...
$string['dashtilenever'] = 'ohne jede Aktivität';
$string['dashviewed'] = 'Geöffnet ohne Bestätigung';
$string['dashopens'] = 'Aufrufe';
$string['dashviewedchip'] = '{$a} angesehen';
$string['dashtileviewed'] = 'Seiten geöffnet ohne Bestätigung';
$string['dashdetail'] = 'Leseübersicht';
$string['dashdetailback'] = 'Zurück zum Dashboard';
$string['dashstateconfirmed'] = 'Bestätigt';
$string['dashstatestale'] = 'Neu bestätigen';
$string['dashstateviewed'] = 'Geöffnet ohne Bestätigung';
$string['dashstatenone'] = 'Nicht geöffnet';
$string['dashconfirmedmeta'] = 'bestätigt am {$a}';
$string['dashstalemeta'] = 'ältere Version bestätigt · {$a}';
$string['dashvisitsmeta'] = '{$a->count} Aufruf(e) · zuletzt {$a->date}';
$string['dashdetailfootnote'] = '„Geöffnet" bedeutet, dass die Person den Artikel geladen hat — Scrollen oder Lesezeit werden nicht gemessen, und Aufrufe zählen nie zum bestätigten Prozentsatz. Aufrufe werden erst seit der Version erfasst, die dieses Signal eingeführt hat; frühere Besuche wurden nicht protokolliert.';
...
$string['dashfootnote'] = 'Grün = auf der aktuell veröffentlichten Version bestätigt; bernstein = eine frühere Version einer seither geänderten Seite bestätigt; grau schraffiert = geöffnet, aber nie bestätigt (die Grauzone: erfasste Aktivität ohne Verbindlichkeit); leerer Hintergrund = nie geöffnet. Öffnen zählt nie zum Prozentsatz: es ist Gesprächskontext, kein Lesenachweis. Ausgeblendete Personen fallen aus Liste und Durchschnitten, ihre Leseeinträge bleiben jedoch unberührt und sie können jederzeit wiederhergestellt werden. Dieses Dashboard misst Bestätigungen, nicht Aufmerksamkeit.';
...
$string['sgtitle_vs'] = 'Direktvergleich nebeneinander (so nicht / so ja)';
$string['sguse_vs'] = 'Zwei vollständige Simulationen im direkten Vergleich: Spalten auf breiten Bildschirmen, auf schmalen automatisch gestapelt. Jedes vs-item trägt is-bad oder is-good, einen vs-tag-Urteilschip („Así no" / „Así sí") und eine optionale vs-note mit der Begründung; die Reihenfolge im Markup ist die Anzeigereihenfolge (schlecht zuerst oder gut zuerst, beides möglich). In jedes Feld gehört ein vollständiges hb-chat, hb-email oder hb-dialogue. Mit dem Urteil am Feld sind is-good/is-bad-Markierungen pro Sprechblase unnötig.';
...
$string['privacy:pageviewspath'] = 'Artikelaufrufe';
$string['privacy:metadata:local_handbook_pageview'] = 'Artikelaufrufe: welche Person welche Handbuchseite geöffnet hat, wie oft, erstmals und zuletzt.';
$string['privacy:metadata:local_handbook_pageview:userid'] = 'Die Person, die die Seite geöffnet hat.';
$string['privacy:metadata:local_handbook_pageview:viewcount'] = 'Wie oft die Seite geöffnet wurde.';
$string['privacy:metadata:local_handbook_pageview:firstviewed'] = 'Wann die Seite zum ersten Mal geöffnet wurde.';
$string['privacy:metadata:local_handbook_pageview:lastviewed'] = 'Wann die Seite zuletzt geöffnet wurde.';
